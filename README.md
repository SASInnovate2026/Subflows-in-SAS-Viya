...
Subflows are saved SAS®  Studio flows that you can add to another flow.  They are useful if you have a group of nodes that you want to reuse in multiple flows within SAS®  Studio.  The use of subflows can also help reduce the complexity of your flow. In this lab, you will create a SAS®  Studio Flow that uses a sub-flow.
